...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\Users\Utilisateur\Herd\idea\public\storage' => 'string',
...
'filesystems.disks.s3.report','filesystems.links.C:\\Users\\Utilisateur\\Herd\\idea\\public\\storage','logging.default','logging.deprecations.channel','logging.deprecations.trace',
...
'boost.executable_paths.php','boost.executable_paths.composer','boost.executable_paths.npm','boost.executable_paths.vendor_bin','mcp.redirect_domains',
...
'boost.browser-logs','dusk.login','dusk.logout','dusk.user','idea.index','idea.store','idea.show','idea.destroy','login',
'storage.local','storage.local.upload',);
        registerArgumentsSet('views', 
'auth.login','auth.register','components.cards','components.forms.error','components.forms.field',
'components.forms.form','components.icons.arrow-back','components.icons.close','components.icons.external','components.ideas.status',
'components.layout.layout','components.layout.nav','components.modal','ideas.index','ideas.show',
...
'C:.Users.Utilisateur.Herd.idea.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.custom.attribute-name.rule-name',);
